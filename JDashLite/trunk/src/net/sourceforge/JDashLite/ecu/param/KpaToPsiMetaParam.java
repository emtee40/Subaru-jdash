 ...
 *
 *********************************************************/
public abstract class KpaToPsiMetaParam extends OneParamMetaParameter
{
	
	/********************************************************
	 * 
	 *******************************************************/
	public KpaToPsiMetaParam(String name, ECUParameter kpa)
	{
		super(name, kpa);
	}
	...
	{
		return 0.09530 * this.p1_.getValue();
	}
