 ...
 *
 *********************************************************/
public abstract class KphToMphMetaParam extends OneParamMetaParameter
{
	
	/********************************************************
	 * 
	 *******************************************************/
	public KphToMphMetaParam(String name, ECUParameter kph)
	{
		super(name, kph);
	}
	...
	{
		return this.p1_.getValue() * 0.62137;
	}
