...
public class ErrorDialog
{
	...
	private static final String STACKTRACE_BUTTON = "Detail";
...
//		}
	...
	{
		new ErrorDialog(WARNING_TITLE, message, null).displayError();
	}
	...
	{
		new ErrorDialog(INFO_TITLE, message, null).displayError();
	}
	...
	{
		new ErrorDialog(HELP_TITLE, message, null).displayError();
	}
	...
	private void displayError()
	{
		...
		this.mb_.setFont(ErrorDialog.font_);
