...
<parameters name="Subaru SSM/OBD-II with OpenPort cable" monitor-class="net.sourceforge.JDash.ecu.comm.SSMOBD2Monitor">
	...
	<meta-parameter name="LOAD">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" ~E_LOAD~ * 100 / 255 " />
        </args>
    </meta-parameter>
	...
	<meta-parameter name="IG_TIMING_DEG">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_IG_TIMING~ - 128) / 2 " />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="KNOCK_COR_DEG">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_KNOCK_COR~ - 128) / 2 " />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="RPM">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" Math.round((BSH.makeint(~E_RPM_H~, ~E_RPM_L~) / 4.0) / 10) * 10 " />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="MAP_PSI">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_MAP~ * 37.0) / 255.0" />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="ATMO_PSI">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_ATMO~ * 37.0) / 255.0" /> 
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="LAMBDA_1">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" ~E_AF_1~ / 128.0 " />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="LAMBDA_2">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" ~E_AF_2~ / 128.0 " />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="INTAKE_AIR_TEMP_C">
      <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
      <args>
          <arg name="script" value=" ~E_INTAKE_AIR_TEMP~ " />
      </args>
    </meta-parameter>
    ...
    <meta-parameter name="COOLANT_TEMP_C">
      <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
      <args>
          <arg name="script" value=" ~E_COOLANT_TEMP~ - 40 " />
      </args>
    </meta-parameter>
    ...
    <meta-parameter name="EGT_C">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value="(~E_EGT~ + 40) * 5"/>
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="GEAR_MANUAL">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value="~E_GEAR_POS~ + 1.0"/>
        </args>
    </meta-parameter>
     ...
     <meta-parameter name="REAR_O2_VOLTS">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" BSH.makeint(~E_REAR_O2V_H~, ~E_REAR_O2V_L~) * 0.005" />
        </args>
    </meta-parameter>
    ...
    <meta-parameter name="DEFOG_SW">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" BSH.bitcheck(~E_BIT_BLOCK_4~, 5) " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="STFT_1">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_AF_COR_1~ - 128.0) / 1.28 " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="STFT_2">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_AF_COR_2~ - 128.0) / 1.28 " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="STFT_3">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_AF_COR_3~ - 128.0) / 1.28 " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="LTFT_1">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_AF_LEARN_1~ - 128.0) / 1.28 " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="LTFT_2">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" (~E_AF_LEARN_2~ - 128.0) / 1.28 " />
        </args>
    </meta-parameter>	
    ...
    <meta-parameter name="INJ_1_PULSE_MS">
        <handler>net.sourceforge.JDash.ecu.param.BeanShellMetaParam</handler>
        <args>
            <arg name="script" value=" ~E_INJ_1_PULSE~ * 0.256 " />
        </args>
    </meta-parameter>	
